function plot_contour(x, y, z, zlines, zlbl, xstr, ystr, tstr, tinterpreter,...
    xlims, ylims, xticks, yticks, plotDir, plotName, legstr, lxlog, lylog, lsave)
...
hlbl = clabel(cs,h,'labelspacing',600,'fontsize',axis_fsz,'fontname',sfont,...
